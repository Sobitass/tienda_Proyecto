   ...
   <body>
      ...
      <div class="gallery_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <h1 class="gallery_taital">Productos</h1>  <div class="seemore_bt"><a href="categoria_registrar.php">Agregar categoria</a></div>
               ...
               <div class="seemore_bt"><a href="producto.php">Agregar producto</a></div>
            </div>
            <div class="">
               <div class="gallery_section_2">
                  <div class="row">
                     <div class="col-md-4">
                        ...
                        <div type="text" class="carrito_bt"><a href="#">Categoria</a></div>
                     </div>
                     <div class="col-md-4">
                        <div class="container_main">
