   ...
   <body>
      ...
      <div class="header_section">
         <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <div class="logo"><a href="index_Vendedor.php"><img src="images/logo.png"></a></div>
               ...
               <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav ml-auto">
                     <li class="nav-item active">
                        <a class="nav-link" href="index_Vendedor.php">Home</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="about.php">About Us</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="producto.php">Producto Nuevo</a>
                     </li>
                     <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="perfil_Ariel.php">Perfil</a>
                     </li>
                  </ul>
               </div>
            </nav>
               ...
               <div class="carousel-inner">
                     ...
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="banner_taital">
                              <h1 class="outstanding_text">Ameizon</h1>
                              <h1 class="coffee_text">El chido</h1>
                  ...
                  <div class="carousel-item">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="banner_taital">
                              <h1 class="outstanding_text"> Productos </h1>
                              <h1 class="coffee_text">Tus marcas favoritas</h1>
                              <p class="there_text">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, </p>
                              <div class="learnmore_bt"><a href="#">Learn More</a></div>
                           </div>
                        </div>
                  ...
                  <div class="carousel-item">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="banner_taital">
                              <h1 class="outstanding_text">Perzonalizables </h1>
                              <h1 class="coffee_text">Personaliza tus productos</h1>
                              <p class="there_text">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, </p>
                              <div class="learnmore_bt"><a href="#">Learn More</a></div>
                           </div>
                        </div>
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="about_taital_main">
                     <div class="about_taital">¿Quiénes somos?</div>
                     ...
                     <div class="read_bt"><a href="about.php">Más información</a></div>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="about_img"><img src="images/logo.png"></div>
               </div>
            </div>
         </div>
      </div>
      ...
      <div class="gallery_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <h1 class="gallery_taital">Productos en stock</h1>
            ...
            <div class="">
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="images/tenis1.png" alt="Avatar" class="image">
                        ...
                        <div type="text" class="carrito_bt"><a href="#">Agregar al carrito</a></div>
                     </div>
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="images/tenis2.png" alt="Avatar" class="image">
                           <div class="overlay">
                              <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                           </div>
                        </div>
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="images/tenis3.png" alt="Avatar" class="image">
                           <div class="overlay">
                              <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                           </div>
                        </div>
               ...
               <div class="gallery_section_2">
                  <div class="row">
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="images/laptop.png" alt="Avatar" class="image">
                           <div class="overlay">
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="images/laptop2.png" alt="Avatar" class="image">
                           <div class="overlay">
                              <div class="overlay">
                                 <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                              </div>
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="images/laptop3.png" alt="Avatar" class="image">
                           <div class="overlay">
                              <div class="overlay">
                                 <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                              </div>
               ...
               <div class="gallery_section_2">
                  <div class="row">
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="images/lentes1.png" alt="Avatar" class="image">
                           <div class="overlay">
                              <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                           </div>
                        </div>
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="images/lentes2.png" alt="Avatar" class="image">
                           <div class="overlay">
                              <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                           </div>
                        </div>
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="images/lentes3.png" alt="Avatar" class="image">
                           <div class="overlay">
                              <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                           </div>
                        </div>
            ...
            <div class="seemore_bt"><a href="gallery.php">Más productos</a></div>
         </div>
      </div>
      <!-- gallery section end -->
      ...
      <div class="services_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <h1 class="services_taital">Perzonalizables</h1>
               ...
               <div class="row">
                  <div class="col-lg-4 col-sm-12 col-md-4">
                     <div class="box_main active">
                        <div class="image">
                           <img src="images/personalizable.jpg" class="image_1">
                           
                        </div>
                        <h3 class="decorate_text">Tazas</h3>
                        <p class="tation_text">Exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea </p>
                        <div class="cotizar_bt"><a href="cotizar.php">Cotizar</a></div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-sm-12 col-md-4">
                     <div class="box_main">
                        <div class="image">
                           <img src="images/personalizable1.png" class="image_1">
                           
                        </div>
                        <h3 class="decorate_text">Yetis</h3>
                        <p class="tation_text">Exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea </p>
                        <div class="cotizar_bt"><a href="cotizar.php">Cotizar</a></div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-sm-12 col-md-4">
                     <div class="box_main">
                        <div class="image">
                           <img src="images/personalizable2.png" class="image_1">
                           
                        </div>
                        <h3 class="decorate_text">Camisas</h3>
                        <p class="tation_text">Exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea </p>
                        <div class="cotizar_bt"><a href="cotizar.php">Cotizar</a></div>
                     </div>
                  </div>
      ...
      <div class="client_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <h1 class="client_taital">Reviews</h1>
                   ...
                   <div class="row">
                      <div class="col-md-12">
                         <div class="testimonial_section_2">
                            <h4 class="client_name_text">Usuario <span class="quick_icon"><img src="images/quick-icon.png"></span></h4>
            ...
            <div class="client_section_2">
                <div class="container">
                   <div class="row">
                      <div class="col-md-12">
                         <div class="testimonial_section_2">
                            <h4 class="client_name_text">Usuario 2 <span class="quick_icon"><img src="images/quick-icon.png"></span></h4>
                            <p class="customer_text">many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All themany variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some embarrassing hidden in the middle of text. All the</p>
                         </div>
                      </div>
                   </div>
            ...
            <div class="client_section_2">
                <div class="container">
                   <div class="row">
                      <div class="col-md-12">
                         <div class="testimonial_section_2">
                            <h4 class="client_name_text">Usuario 3 <span class="quick_icon"><img src="images/quick-icon.png"></span></h4>
                            <p class="customer_text">many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All themany variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some embarrassing hidden in the middle of text. All the</p>
                         </div>
                      </div>
                   </div>
                  ...
                  <div class="mail_section">
                     <div class="email_text">
                        <div class="form-group">
                           <input type="text" class="email-bt" placeholder="Nombre" name="Email">
                        </div>
                        <div class="form-group">
                           <input type="text" class="email-bt" placeholder="Email" name="Email">
                        </div>
                        <div class="form-group">
                           <input type="text" class="email-bt" placeholder="Telefono" name="Email">
                        </div>
                        <div class="form-group">
                           <textarea class="massage-bt" placeholder="Mensaje" rows="5" id="comment" name="Massage"></textarea>
                        </div>
                        <div class="send_btn">
                           <div type="text" class="main_bt"><a href="#">Enviar</a></div>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="row">
               ...
               <div class="col-lg-3 col-sm-6">
                  ...
                  <div class="footer_menu">
                     <ul>
                        <li><a href="index_Vendedor.php">Home</a></li>
