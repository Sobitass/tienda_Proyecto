...
<body>
    ...
    <div class="header_section">
      ...
      <!--header section end -->
    <section class="py-4 py-xl-5" style="height: 141.391px;margin-top: -36px;">
        <div class="container">
            <div class="bg-light border rounded border-0 border-light d-flex flex-column justify-content-between flex-lg-row p-4 p-md-5">
                <div class="pb-2 pb-lg-1">
                    <h2 class="fw-bold mb-2">Categorias</h2>
                    <p class="mb-0">Imperdiet consectetur dolor, tristique himenaeos ultrices tristique neque.</p>
                </div>
                <a class="btn btn-primary fs-5 py-2 px-4" role="button" href="categoria_registrar.php">Nueva categoría</a>
            </div>
        </div>
    </section>
    ...
    <div style="margin: 100px;">
        <div data-reflow-type="product-list" data-reflow-order="date_desc" style="padding-bottom: 0px;"></div>
    </div>
