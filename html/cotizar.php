      ...
      <div class="about_section layout_padding">
         <div class="container">
            <div class="glass-container">
                <h1>Cotizar</h1>
                <form class="glass-form" id="submission-form">
                    <label for="username">Nombre del cliente</label>
                    <input type="text" id="username" name="username"/>
        
                    <label for="nombre_User">Nombre del proveedor</label>
                    <input type="text" id="nombre_User" name="nombre_User"/>
        
                    <label for="Apellido_User">Paquete</label>
                    <input type="text" id="Apellido_User" name="Apellido_User"/>
                    ...
                    <a href="home.html">
                        <button class="btnLogin-popup">Realizar cotización</button>
                    </a>
                </form>
            </div>
               
                
                <!-- <a href="profile_User2.html">
                    <button class="btnLogin-popup" id="registerButton" onclick="return confirmNavigation()">Registrate</button>
                </a> -->
